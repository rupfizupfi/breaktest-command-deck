...
async function list_1(pageable: Pageable_1 | undefined, filter: Filter_1 | undefined, init?: EndpointRequestInit_1): Promise<Array<User_1>> { return client_1.call("UserEndpoint", "list", { pageable, filter }, init); }
