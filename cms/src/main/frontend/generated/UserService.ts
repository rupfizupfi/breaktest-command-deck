...
async function count_1(filter: Filter_1 | undefined, init?: EndpointRequestInit_1): Promise<number> { return client_1.call("UserService", "count", { filter }, init); }
...
async function save_1(user: User_1, init?: EndpointRequestInit_1): Promise<User_1> { return client_1.call("UserService", "save", { user }, init); }
