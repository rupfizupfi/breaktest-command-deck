...
class GearTypeModel<T extends GearType_1 = GearType_1> extends AbstractEntityModel_1<T> {
    static override createEmptyValue = makeObjectEmptyValueCreator_1(GearTypeModel);
